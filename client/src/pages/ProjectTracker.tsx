...
<body>
  <div style="max-width:900px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:40px;padding-bottom:24px;border-bottom:2px solid #c9a96e;">
      <div style="font-size:11px;color:#8b7b6b;letter-spacing:0.15em;text-transform:uppercase;margin-bottom:6px;">Easy Book Publishers</div>
    ...
    <div style="text-align:center;margin-top:40px;padding-top:20px;border-top:1px solid #e8dfd0;">
      ...
      <p style="font-size:11px;color:#a89880;">Easy Book Publishers — Manuscript to Masterpiece</p>
    </div>
  </div>
</body>
</html>`;
