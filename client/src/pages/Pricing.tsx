...
const tiers = [
  {
    ...
    features: [
      ...
      { name: "Guided publishing journey", included: true },
      { name: "AI typesetting (PDF + EPUB)", included: false },
      { name: "Amazon KDP-ready export", included: false },
      { name: "Production timeline", included: false },
      { name: "Book templates library", included: false },
  ...
  },
  {
    ...
    description: "Full publishing toolkit with AI-powered typesetting. Like Atticus + Vellum, but online.",
    icon: Zap,
    ...
    features: [
      ...
      { name: "Amazon KDP-ready export", included: true },
      { name: "Production timeline", included: true },
      { name: "Book templates library", included: true },
      { name: "Priority email support", included: false },
    ],
  },
  {
...
const comparisonFeatures: Array<{ name: string; tooltip?: string; starter: string | boolean; author: string | boolean; publisher: string | boolean }> = [
  ...
  { name: "ISBN & ONIX Metadata", starter: true, author: true, publisher: true },
  ...
  { name: "AI Typesetting Engine", tooltip: "Automated book layout with professional styles", starter: false, author: true, publisher: true },
...
const competitors = [
  { name: "Atticus", price: "$147 one-time", scope: "Writing + formatting only" },
  { name: "Vellum", price: "$250–$500", scope: "Formatting only, Mac only" },
  { name: "IngramSpark", price: "$49/title + print costs", scope: "Distribution only" },
  { name: "BookBaby", price: "$400–$4,000+", scope: "Full-service packages" },
];
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="mb-20 bg-white rounded-2xl border border-[#c9a96e]/15 p-8">
          ...
          <div className="text-center mt-6 bg-gradient-to-r from-[#c9a96e]/10 to-[#d4b480]/10 rounded-xl p-5 border border-[#c9a96e]/20">
            ...
            <p className="text-[#8b6914] font-bold text-xl mt-1">$149 lifetime <span className="text-sm font-normal text-[#5c4a2a]/60">or $9.99/mo annually</span></p>
            <p className="text-sm text-[#5c4a2a]/70 mt-2">Writing workflow + AI typesetting + cover specs + ISBN manager + KDP export + production timeline — all in one platform, on any device.</p>
          </div>
        </div>
