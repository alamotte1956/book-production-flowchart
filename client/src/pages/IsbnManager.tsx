...
<ONIXMessage release="3.0"
  ...
  <Header>
    ...
    <MessageNote>Generated by Easy Book Publishers LLC</MessageNote>
  </Header>
  <Product>
            ...
            <Card className="border-[#e8dfd0] bg-white shadow-sm">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  {isbn10 && (
                    <div className="mt-3">
                      <Label className="text-[#5c3d2e] font-semibold text-sm">ISBN-10 (auto-calculated)</Label>
                      <Input
                        value={isbn10}
                        readOnly
                        className="mt-1 border-[#d4c8b4] font-mono bg-[#f5f0e8] text-[#5c3d2e] cursor-default"
                      />
                    </div>
                  )}
                </div>
