...
<head>
  ...
  ${style.googleFontsUrl
    ? `<link rel="preconnect" href="https://fonts.googleapis.com" /><link href="${style.googleFontsUrl}" rel="stylesheet" />`
    : `<style>
    /* GNU FreeFont @font-face — served from system font path for local PDF rendering */
    @font-face { font-family: 'FreeSerif'; font-weight: normal; font-style: normal; src: local('FreeSerif'), url('file:///usr/share/fonts/truetype/freefont/FreeSerif.ttf') format('truetype'); }
    @font-face { font-family: 'FreeSerif'; font-weight: bold;   font-style: normal; src: local('FreeSerif Bold'), url('file:///usr/share/fonts/truetype/freefont/FreeSerifBold.ttf') format('truetype'); }
    @font-face { font-family: 'FreeSerif'; font-weight: normal; font-style: italic; src: local('FreeSerif Italic'), url('file:///usr/share/fonts/truetype/freefont/FreeSerifItalic.ttf') format('truetype'); }
    @font-face { font-family: 'FreeSerif'; font-weight: bold;   font-style: italic; src: local('FreeSerif Bold Italic'), url('file:///usr/share/fonts/truetype/freefont/FreeSerifBoldItalic.ttf') format('truetype'); }
    @font-face { font-family: 'FreeSans';  font-weight: normal; font-style: normal; src: local('FreeSans'), url('file:///usr/share/fonts/truetype/freefont/FreeSans.ttf') format('truetype'); }
    @font-face { font-family: 'FreeSans';  font-weight: bold;   font-style: normal; src: local('FreeSans Bold'), url('file:///usr/share/fonts/truetype/freefont/FreeSansBold.ttf') format('truetype'); }
    @font-face { font-family: 'FreeSans';  font-weight: normal; font-style: italic; src: local('FreeSans Oblique'), url('file:///usr/share/fonts/truetype/freefont/FreeSansOblique.ttf') format('truetype'); }
    @font-face { font-family: 'FreeSans';  font-weight: bold;   font-style: italic; src: local('FreeSans Bold Oblique'), url('file:///usr/share/fonts/truetype/freefont/FreeSansBoldOblique.ttf') format('truetype'); }
    @font-face { font-family: 'FreeMono';  font-weight: normal; font-style: normal; src: local('FreeMono'), url('file:///usr/share/fonts/truetype/freefont/FreeMono.ttf') format('truetype'); }
    @font-face { font-family: 'FreeMono';  font-weight: bold;   font-style: normal; src: local('FreeMono Bold'), url('file:///usr/share/fonts/truetype/freefont/FreeMonoBold.ttf') format('truetype'); }
    @font-face { font-family: 'FreeMono';  font-weight: normal; font-style: italic; src: local('FreeMono Oblique'), url('file:///usr/share/fonts/truetype/freefont/FreeMonoOblique.ttf') format('truetype'); }
    @font-face { font-family: 'FreeMono';  font-weight: bold;   font-style: italic; src: local('FreeMono Bold Oblique'), url('file:///usr/share/fonts/truetype/freefont/FreeMonoBoldOblique.ttf') format('truetype'); }
  </style>`
  }
  <style>
    @page {
