...
export const TYPESETTING_STYLES: TypesettingStyle[] = [
  ...
  // ─── GNU FreeFont (freefont-20120503) ─────────────────────────────────────────
  {
    id: "gnu-freeserif",
    label: "GNU FreeSerif (Serif)",
    group: "General",
    fontFamily: "'FreeSerif', 'Liberation Serif', Georgia, serif",
    fontSize: 11,
    lineHeight: 1.55,
    chapterHeadingFont: "'FreeSerif', Georgia, serif",
    chapterHeadingSize: 18,
    dropCap: true,
    chapterBreakStyle: "page-break",
    bodyColor: "#1a1a1a",
  ...
  {
    id: "gnu-freesans",
    label: "GNU FreeSans (Sans-Serif)",
    group: "General",
    fontFamily: "'FreeSans', 'Liberation Sans', Arial, sans-serif",
    fontSize: 11,
    lineHeight: 1.55,
    chapterHeadingFont: "'FreeSans', Arial, sans-serif",
    chapterHeadingSize: 18,
    dropCap: false,
    chapterBreakStyle: "page-break",
    bodyColor: "#1a1a1a",
  ...
  {
    id: "gnu-freemono",
    label: "GNU FreeMono (Monospace)",
    group: "General",
    fontFamily: "'FreeMono', 'Liberation Mono', 'Courier New', monospace",
    fontSize: 10,
    lineHeight: 1.6,
    chapterHeadingFont: "'FreeMono', 'Courier New', monospace",
    chapterHeadingSize: 16,
    dropCap: false,
    chapterBreakStyle: "page-break",
    bodyColor: "#1a1a1a",
